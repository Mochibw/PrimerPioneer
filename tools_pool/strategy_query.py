...
openai_client = OpenAI(
    base_url="http://183.166.183.48:31000/v1",  # Default for gpt-oss
    api_key="sk-D6qbkOihiky065Dq02C0F99895274880832d9705C83b9cAb"
)
...
if __name__ == "__main__":
    ...
    demo_files = [
        "C:\github_repo\PPversion2\data\strategy.md"
    ]
