...
from tools_pool.select_cloning_method import select_cloning_method
from tools_pool.evaluate_sequence import evaluate_sequence
...
mcp.tool()(select_cloning_method) # 选择路线
mcp.tool()(evaluate_sequence) # 序列评估
